...
export function LoginForm({
  ...
  const {
    ...
    mode: "onSubmit",        // chỉ validate lần đầu khi nhấn submit
    reValidateMode: "onSubmit", // sau đó cũng chỉ validate lại khi submit tiếp
        ...
        <div className="flex-1 px-8 py-10 md:px-10">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              >
                <Image src="/google_logo.png" alt="Google" width={20} height={20} className="h-5 w-5 object-contain" />
                Login with Google
              </button>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-lg py-2.5 text-sm text-gray-700 font-medium hover:bg-gray-50 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <Image src="/facebook.png" alt="Facebook" width={20} height={20} className="h-5 w-5 object-contain" />
                Login with Facebook
              </button>
            </div>
          </form>
